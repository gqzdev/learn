                ...
                <!-- 搜索 start -->
				 <div style="position: absolute;top: -11px;left: 240px;">
					<form class="navbar-form navbar-right" role="search" 
							action="<%=basePath%>searchCourseInfoByTerm.html" method="post">
						<div class="form-group">
							<input type="text" class="form-control" name="searchContent" placeholder="课程名称">
						</div> 
						<div class="form-group">
					...
					<div>
						<button id="addBtn" type="button" class="btn btn-default wk-tool-btn" style="position: absolute;top: 10px;right: -320px;">加入课程</button>
					</div>
				 </div>
				 <!-- 搜索 end -->
            </div>
