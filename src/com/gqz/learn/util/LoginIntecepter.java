...
public class LoginIntecepter implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response,Object obj) throws Exception {
		...
		if (uri.endsWith("login.html")||uri.endsWith("login.jsp") || uri.endsWith("login") || 
				uri.endsWith("preLogin.html")  || uri.endsWith("css") || uri.endsWith("js")) {
			//访问登录页面时，直接访问
			return true; 
		}else if (object!=null) {
			...
			response.sendRedirect(request.getContextPath()+"/preLogin.html");
		}
		return false;
	}
